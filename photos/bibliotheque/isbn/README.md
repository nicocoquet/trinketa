...
2. Déposer une ou plusieurs images. L’interface les convertit en JPEG sans métadonnées, crée une branche et une pull request ; fusionner celle-ci après contrôle pour alimenter `a_traiter/`.
